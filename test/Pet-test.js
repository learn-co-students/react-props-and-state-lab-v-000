                                ...
                                it('should only show the adopt button', () => {
                                  ...
                                  it('should call the `onAdoptPet` callback prop when the adopt button is clicked', () => {
                                      ...
                                      const wrapper = shallow( < Pet pet = {
                                        ...
                                        />);
                                        wrapper.find('button.ui.primary.button').simulate('click'); expect(spy.calledOnce).to.be.true; expect(spy.firstCall.args[0]).to.equal(FEMALE_CAT.id);
                                      });
                                    ...
                                    it('should call the `onAdoptPet` callback prop with the pet ID', () => {
                                        ...
                                        const wrapper = shallow( < Pet pet = {
                                          ...
                                          />);
                                          wrapper.find('button.ui.primary.button').simulate('click'); expect(spy.firstCall.args[0]).to.equal(FEMALE_CAT.id);
                                        });
                                    });
                                    ...
                                    it('should only show the already adopted button', () => {
                                      ...
                                      it('should not call the `onAdoptPet` callback prop when the button is clicked', () => {
                                          ...
                                          const wrapper = shallow( < Pet pet = {
                                            ...
                                            />);
                                            wrapper.find('button.ui.disabled.button').simulate('click'); expect(spy.called).to.be.false;
                                          });
                                      });
                                  });
                                });
