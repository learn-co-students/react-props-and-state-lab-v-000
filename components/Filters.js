...
class Filters extends React.Component {
  ...
  handleFilterTypeChange(data)  {
    this.props.onChangeType(data.target.value)
  }

  handleFindPetsClick(data){
  ...
  render() {
    return (
      <div className="ui form">
        <h3>Animal type</h3>
        <div className="field">
          <select value={this.props.filters.type} onChange={this.handleFilterTypeChange} name="type" id="type">
