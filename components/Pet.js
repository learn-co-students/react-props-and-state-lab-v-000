...
class Pet extends React.Component {
  constructor() {
    super();
    this.handleAdoptButton = this.handleAdoptButton.bind(this)
  }
    ...
    return (
      <div className="card">
        ...
        <div className="extra content">
          {!this.props.isAdopted && <button className="ui primary button" onClick={this.handleAdoptButton}>Adopt pet</button>}
